          ...
          <div className="flex h-full max-h-screen flex-col gap-2 sticky top-0 z-50">
            ...
            <div className="flex-1 ">
              <nav className="grid items-start px-2 text-sm font-medium lg:px-4 gap-2 mt-1">
                <Link href={`/customer/${url}/overview`} className={`${path.includes('/overview') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                ...
                <Link href={`/customer/${url}/cashbacks`} className={`${path.includes('/cashbacks') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Cashbacks
                </Link>
                <Link href={`/customer/${url}/benefits`} className={`${path.includes('/benefits') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Active Benefits
                </Link>
                <Link href={`/customer/${url}/tickets`} className={`${path.includes('/tickets') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Tickets
                </Link>
                <Link href={`/customer/${url}/voucher`} className={`${path.includes('/voucher') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Voucher
                </Link>
                <Link href={`/customer/${url}/remaining-amount`} className={`${path.includes('/remaining-amount') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Remaining Amount
                </Link>
                <Link href={`/customer/${url}/extra-amount`} className={`${path.includes('/extra-amount') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Extra Amount
                ...
                <Link href={`/customer/${url}/amount-of-cashback`} className={`${path.includes('/amount-of-cashback') ? 'bg-accent text-foreground' : ' text-muted-foreground'} font-semibold flex items-center gap-3 rounded-md px-3 py-2 text-primary transition-all hover:text-primary hover:bg-accent duration-200`}>
                <div className="border border-foreground/30 rounded-md dark:bg-black p-1 bg-white">
                  <Users className="h-4 w-4" />
                  </div>
                  Amount of Cashback
